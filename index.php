      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0">Apna<span class="text-primary">Bank</span> </a></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="money.php"class="nav-link">Money Transfer</a></li>
                    <li><a href="history.php" class="nav-link">Transaction History</a></li>
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-10 mt-lg-5 text-center">
            <div class="single-text owl-carousel">
              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">Apna Bank</h1>
                <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Bank Aisa, Apne Jaisa</p>
        ...
        <div class="row mb-5">
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <span>St. Vincent Pallotti College of Engineering and technolgy, Nagpur</span>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-4">
              <span class="icon-phone d-block h2 text-primary"></span>
              <a href="tel:+91 9881678709">+91 9881678709</a> <br>
              <a href="tel:+91 9420553066">+91 9420553066</a>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-0">
              <span class="icon-mail_outline d-block h2 text-primary"></span>
              <a href="mailto:urviramekar@gmail.com">urviramekar@gmail.com</a>
            </p>
          </div>
        </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <div class="border-top pt-5">
              ...
              <p>Copyright &copy;
                <script>document.write(new Date().getFullYear());</script> All rights reserved | Designed with <i class="icon-heart-o" aria-hidden="true"></i> by <a>Urvi Ramekar</a>
              </p>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
